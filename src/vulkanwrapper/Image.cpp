...
void Image::create(const VkImageType vk_imageType, const VkFormat vk_imageFormat, const VkExtent3D vk_imageExtent, const uint32_t arrayLayerCount, const VkSampleCountFlagBits vk_sampleCount, const VkImageUsageFlags vk_imageUsage, const uint32_t mipLevelCount, const VkImageLayout vk_initialLayout)
{
    const VkImageCreateInfo vk_imageCreateInfo = {
        ...
        .initialLayout = vk_initialLayout,
    };
...
Image::~Image()
{
    vkDestroyImage(s_vkDevice, m_vkImage, nullptr);
